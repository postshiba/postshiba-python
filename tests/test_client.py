...
def test_send_on_cluster_idempotency_and_sandbox(http):
    ...
    result = client().emails.send_on_cluster(4, body, idempotency_key="idem-1", sandbox=True)
    req = last_request(http)
    assert req.get_method() == "POST"
    assert req.full_url == "https://api.example.test/api/v1/teams/1/clusters/4/sends"
...
OPERATIONS = [
    ...
    (
        ...
        lambda c: c.emails.send_on_cluster(4, load_fixture("email_send_request")),
        "POST",
        "/api/v1/teams/1/clusters/4/sends",
        load_fixture("email_send_request"),
        load_fixture("email_sandbox_response"),
    ),
    ("clusters.list", lambda c: c.clusters.list(), "GET", "/api/v1/teams/1/clusters", None, [load_fixture("cluster")]),
    ("clusters.get", lambda c: c.clusters.get(4), "GET", "/api/v1/clusters/4", None, load_fixture("cluster")),
    (
        "clusters.create",
    ...
    (
        "clusters.update",
        lambda c: c.clusters.update(4, load_fixture("cluster_update_request")),
        "PATCH",
        "/api/v1/clusters/4",
        load_fixture("cluster_update_request"),
        load_fixture("cluster_updated"),
    ),
    ("clusters.suspend", lambda c: c.clusters.suspend(4), "POST", "/api/v1/clusters/4/suspend", None, load_fixture("cluster_suspended")),
    ("clusters.resume", lambda c: c.clusters.resume(4), "POST", "/api/v1/clusters/4/resume", None, load_fixture("cluster")),
    ("clusters.delete", lambda c: c.clusters.delete(4), "DELETE", "/api/v1/clusters/4", None, load_fixture("cluster_deprovisioned")),
    (
    ...
    ("sending_domains.get", lambda c: c.sending_domains.get(8), "GET", "/api/v1/sending_domains/8", None, load_fixture("sending_domain")),
    (
    ...
    ("sending_domains.verify", lambda c: c.sending_domains.verify(8), "POST", "/api/v1/sending_domains/8/verify", None, load_fixture("sending_domain")),
    (
        "sending_domains.suspend",
        lambda c: c.sending_domains.suspend(8),
        "POST",
        "/api/v1/sending_domains/8/suspend",
        None,
        load_fixture("sending_domain_suspended"),
    ),
    ("sending_domains.resume", lambda c: c.sending_domains.resume(8), "POST", "/api/v1/sending_domains/8/resume", None, load_fixture("sending_domain")),
    (
        "sending_domains.make_primary",
        lambda c: c.sending_domains.make_primary(8),
        "POST",
        "/api/v1/sending_domains/8/make_primary",
        None,
        load_fixture("sending_domain_primary"),
    ),
    ("sending_domains.delete", lambda c: c.sending_domains.delete(8), "DELETE", "/api/v1/sending_domains/8", None, load_fixture("empty")),
    ("tenants.list", lambda c: c.tenants.list(), "GET", "/api/v1/teams/1/tenants", None, [load_fixture("tenant")]),
    ("tenants.get", lambda c: c.tenants.get(12), "GET", "/api/v1/tenants/12", None, load_fixture("tenant")),
    (
        "tenants.create",
    ...
    ("tenants.delete", lambda c: c.tenants.delete(12), "DELETE", "/api/v1/tenants/12", None, load_fixture("empty")),
    ("inboxes.list", lambda c: c.inboxes.list(), "GET", "/api/v1/teams/1/inboxes", None, [load_fixture("inbox_index")]),
    ("inboxes.get", lambda c: c.inboxes.get(3), "GET", "/api/v1/inboxes/3", None, load_fixture("inbox")),
    (
        "inboxes.create",
    ...
    ("inboxes.verify", lambda c: c.inboxes.verify(3), "POST", "/api/v1/inboxes/3/verify", None, load_fixture("inbox_index")),
    ("inboxes.delete", lambda c: c.inboxes.delete(3), "DELETE", "/api/v1/inboxes/3", None, load_fixture("inbox_index")),
    ("messages.list", lambda c: c.messages.list(3), "GET", "/api/v1/inboxes/3/inbound_messages", None, [load_fixture("message")]),
    ("messages.get", lambda c: c.messages.get(3, 21), "GET", "/api/v1/inboxes/3/inbound_messages/21", None, load_fixture("message_show")),
    ("events.list", lambda c: c.events.list(4), "GET", "/api/v1/teams/1/clusters/4/message_events", None, [load_fixture("event")]),
    ("events.get", lambda c: c.events.get(44), "GET", "/api/v1/message_events/44", None, load_fixture("event")),
    (
        "smtp_credentials.create",
        lambda c: c.smtp_credentials.create(4, load_fixture("smtp_credential_create_request")),
        "POST",
    ...
    (
        ...
        lambda c: c.smtp_credentials.delete(4, 9),
        "DELETE",
        "/api/v1/teams/1/clusters/4/smtp_credentials/9",
        None,
        load_fixture("smtp_credential_deleted"),
    ),
    ("webhooks.list", lambda c: c.webhooks.list(), "GET", "/api/v1/teams/1/webhook_endpoints", None, [load_fixture("webhook")]),
    ("webhooks.get", lambda c: c.webhooks.get(2), "GET", "/api/v1/webhook_endpoints/2", None, load_fixture("webhook_show")),
    (
        "webhooks.create",
    ...
    ("suppressions.delete", lambda c: c.suppressions.delete(7), "DELETE", "/api/v1/suppressions/7", None, load_fixture("empty")),
    ("firewall.get", lambda c: c.firewall.get(), "GET", "/api/v1/teams/1/firewall", None, load_fixture("firewall")),
    (
        "firewall.update",
    ...
    ("firewall.delete_entry", lambda c: c.firewall.delete_entry(3), "DELETE", "/api/v1/firewall_entries/3", None, load_fixture("empty")),
]
...
def test_download_attachment_path(http):
    ...
    result = client().messages.download_attachment(3, 21, 1)
    req = last_request(http)
    assert req.get_method() == "GET"
    assert req.full_url == "https://api.example.test/api/v1/inboxes/3/inbound_messages/21/attachments/1"
...
def test_smtp_password_present_on_create_absent_on_delete(http):
    ...
    created = client().smtp_credentials.create(4, load_fixture("smtp_credential_create_request"))
    assert created["password"] == "once-only-password"
    set_json(http, load_fixture("smtp_credential_deleted"))
    deleted = client().smtp_credentials.delete(4, 9)
